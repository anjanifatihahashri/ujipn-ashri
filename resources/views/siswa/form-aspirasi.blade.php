...
<div class="main-content min-vh-100">
    <div class="card">
        ...
        <p class="fs-5 fst-italic">Isi data di bawah ini dengan benar!</p>
        <form action="{{ route('siswa.proses-tambah') }}" method="POST">
            ...
            <div class="form-group row mb-3 d-flex align-items-center">
                ...
                <div class="col-9">
                    <input class="form-control" type="text" name="kelas" id="" value="{{ auth()->user()->siswa->kelas }}" disabled>
                </div>
            </div>
            <div class="form-group row mb-3 d-flex align-items-center">
            ...
            <div class="form-group row mb-3 d-flex align-items-center">
                ...
                <div class="col-9">
                    <input class="form-control @error('judul') is-invalid @enderror" name="judul" type="text" name="judul" id="">
                    @error('judul')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="form-group row mb-3 d-flex align-items-center">
                ...
                <div class="col-9">
                    <textarea name="isi" id="" rows="10" class="form-control @error('isi') is-invalid @enderror" name="isi"></textarea>
                     @error('isi')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="d-flex justify-content-between">
                ...
                <a href="{{ route('siswa.dashboard') }}" class="btn btn-secondary"><i class="fas fa-close"></i>
                    Cancel</a>
            </div>
        </form>
</div>
