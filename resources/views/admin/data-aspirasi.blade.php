                ...
                @foreach ($aspirasi as $item)
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            @else
                                <a href="" class="btn btn-sm btn-info m-0 me-2 text-white tombolEdit {{ $item->status == 'selesai' || $item->status == 'ditolak' ? 'disabled' : '' }}"
                                    data-bs-toggle="modal" data-bs-target="#exampleModal" data-id="{{ $item->id }}">
                                    <i class="fas fa-edit"></i> Ubah
                                </a>
                            @endif
                            <a href="/admin/aspirasi/delete/{{ $item->id }}" class="btn btn-sm btn-danger m-0 {{ !in_array($item->status, ['selesai', 'ditolak']) ? 'disabled' : '' }}"
